...
const Layout = ({ children }) => {
  return (
    <div className="min-h-dvh flex flex-col justify-between bg-bg text-primary font-mono transition-colors duration-300 md:px-30">
      <nav
        className="py-4 px-10 flex justify-between items-center sticky top-0 z-40
      ...
      <main className="px-4 md:px-10 py-4 flex-1">{children}</main>

      {/* Hidden on mobile */}
      <footer
        className="hidden md:flex py-4 px-10 justify-between items-center
